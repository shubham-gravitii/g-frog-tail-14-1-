            ...
            <div className="product__item white-bg mb-30 wow fadeInUp" data-wow-delay=".3s">
               <div className="product__thumb">
                  ...
                  <div className="product__thumb-btn transition-3">
                     <Link href="/cart">
                        <a>
                           <button onClick={() => dispatch(addToProduct(product))} href="#" className="m-btn m-btn-6 mb-15"> Buy Now </button>
                        </a>
                     </Link>
               ...
               <div className="product__content">
                  ...
                  <p className="product__author">by <a href="#">Gravitii</a> in <a href="#">Templates</a></p>
               </div>
            </div>
         </div>
      </>
