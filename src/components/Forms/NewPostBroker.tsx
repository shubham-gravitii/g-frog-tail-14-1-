      ...
      <>
        ...
        <meta httpEquiv='pragma' content='no-cache' />
          ...
          <div className="section__title-wrapper text-center mb-60">
            ...
            <p style={{ color: 'white' }}>Post your load</p>
            <br />
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="mt-3">
                    ...
                    <Input
                      type="text"
                      maxLength={25}
                      onChange={(event: React.ChangeEvent<HTMLInputElement>)=>setIDName(event.target.value)}
                      name="name"
                      id="name"
                  ...
                  <div className="mt-3">
                    ...
                    <Input
                      type="text"
                      maxLength={25}
                      onChange={(event: React.ChangeEvent<HTMLInputElement>)=>setIDLoad(event.target.value)}
                      name="volume"
                      id="volume"
                    />
                  </div>
                  ...
                  <div className="mt-3">
                    ...
                    <Input
                      ...
                      type="text"
                      maxLength={25}
                      onChange={(event: React.ChangeEvent<HTMLInputElement>) => {setTimestamps(event.target.value)}}
                      name="rate"
                      id="rate"
                    />
                  </div>
