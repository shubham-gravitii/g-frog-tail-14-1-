...
import Client from './posty/MapForOwner/ClientMap'
...
const NewPost = () => {
  ...
  const onSubmit = async () => {
    ...
    if (usrRole == "Carrier") {
      ...
      axios
        .post(Constants.api_gateway_host + "/" + params_customer_string, article, {
          headers,
        })
        .then((response) => {
          console.log(response);
              ...
              <Container fluid={true}>
                <div className="sign__wrapper white-bg">
                  <div className="sign__form">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <div className="mt-3">
                        <p className="mb-3 select3-container">Requirement post  ID</p>
                        <Input
                          type="text"
                          maxLength={50}
                      ...
                      <div className="mt-3">
                        <p className="mb-3 select3-container">Requirement ID Created Timestamp</p>
                      ...
                      <div className="mt-3">
                        <p className="mb-3 select3-container">Requirement Start Date</p>
      ...
      <button className="got-it-button">Got it</button>
        ...
        />
                          ...
                          <div>
                           ...
                           <Client WarehouseID={whId} OwnerID={ownerEntityId}/>
