...
type Props = {
    onSourceAddressChange?: (newType: string) => void;
  };

export var AddressSuggestionsSource: FC = ({
    ...
    const getAddressLocations = async () => {
        ...
        query_string = "?COUNTRY=" + selectedSourceCountry + "&SEARCH_WORD=" + searchAddress
                        ...
                        <div className="input-group mt-3">
                            ...
                            <Select
                                ...
                                onChange={(event: React.ChangeEvent<HTMLSelectElement>) => {
                                    setSelectedSourceCountry(event['value']);
                                }}
...

            {
                ...
                triggerSearch == "true" && (
                    ...
                    <div className="mt-3">
                        ...
                        <Select
                            onChange={(event: React.ChangeEvent<HTMLSelectElement>) => onSourceAddressChange?.(event['value'])}
